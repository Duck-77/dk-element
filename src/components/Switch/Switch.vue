<template>
    <div class="dk-switch" :class="{
        ...
        <input ref="inputRef" class="dk-switch__input" type="checkbox" role="switch" :name="name" v-model="switchValue"
            :disabled="notAllowed" @keydown.enter="handleSwitchToogle">
        </input>
        ...
        <div class="dk-switch__core" @click.prevent="handleSwitchToogle">
            ...
            <div class="dk-switch__core-inner">
                <span v-if="activeText && inactiveText" class="dk-switch__core-inner-text">
