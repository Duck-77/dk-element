    ...
    <div class="dk-input" :class="{
        ...
        <template v-if="type !== 'textarea'">
            ...
            <div class="dk-input__wrapper" :class="{ 'is-focus': isFocus }">
                ...
                <input ref="inputRef" class="dk-input__inner" :style="inputStyle" v-bind="attrs" v-model="inputValue"
                    :type="showPassword ? (!passwordVisible ? 'password' : 'text') : type" :readonly="readonly"
                    :placeholder="placeholder" :form="form" :autocomplete="autocomplete" :autofocus="autofocus"
                    :disabled="disabled" @focus="($event) => handleFocus($event)" @blur="($event) => handleBlur($event)"
                    @change="handleChange" />
                <!-- slots.suffix -->
        ...
        <!-- textarea -->
        <template v-else>
            <textarea ref="inputRef" class="dk-textarea__wrapper" :style="inputStyle" v-bind="attrs"
                v-model="inputValue" :readonly="readonly" :placeholder="placeholder" :form="form"
                :autocomplete="autocomplete" :autofocus="autofocus" :disabled="disabled"></textarea>
        </template>
    </div>
</template>
